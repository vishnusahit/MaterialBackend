...
entity Volume_unit : CodeList {
    key unit : String;
}

entity Material_type : CodeList {
    key Material_type : String(4);
}

entity Plant_List : CodeList {
    key WERKS : String;
}

entity Profit_Center : CodeList {
    key PRCTR : String(10);
}

entity Value_help : cuid, managed {
    Table_name    : String;
    UI_block      : String;
    Column_name   : String;
...
entity Rule_Framework_error : cuid {
    Entity           : String;
    Business_ID      : String;
    Column_Validates : String;
    validate_outcome : String;
    Rule_type        : String;
    Reason           : String;
}
...
entity Mara_staging_dummy : cuid, managed {
    key MATNR               : String(40); // Material Number
        ...
        MEINS_UOM           : String(3); // Base Unit of Measure
        MSTAE               : String(2); // Cross-Plant Material Status
        MSTDE               : Date; // Date from which the Cross-Plant Material Status is Valid
        MTART_Material_type : String(4); // Material Type
        SPART               : String(2); // Division
        EXTWG               : String(18); // External Material Group
        MAGRV               : String(4); // Material Group: Packaging Materials
        MTPOS_MARA          : String(4); // General Item Category Group
